...
//			return new String(HexUtil.bytes2Hex(en_data));
    ...
    public static String decryptString(String encrypttext) {
        try {
            return decryptString(getDefaultPrivateKey(), encrypttext);
        } catch (Exception e) {
            return "";
        }
    }
...
//		return ci.doFinal(data);
    ...
    public static PublicKey getDefaultPublicKey() throws Exception {
        return getPublicKey(RSAKeyConstants.publicKey);
    }
    ...
    public static PrivateKey getDefaultPrivateKey() throws Exception {
        return getPrivateKey(RSAKeyConstants.privateKey);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        //私钥解密
        PrivateKey privateKey = RSAUtil.getDefaultPrivateKey();
