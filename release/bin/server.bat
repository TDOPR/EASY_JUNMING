...
set SERVER_NAME=easyTrade-platform
set VERSION=1.0.0
set CONF=conf/platform-application.yml
set SERVER_JAR=lib/%SERVER_NAME%-%VERSION%.jar
...
set JAVA_OPT=%JAVA_OPT% -Dloader.path=lib/common,lib/platform
