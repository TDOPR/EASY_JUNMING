...
//     * @param id 渠道Id
//     */
//    @OperationLog(module = OperationModel.SYS_CHANNEL,description = OperationAction.REMOVE)
//    @DeleteMapping("/{id}")
...
//     * 添加或修改
//     */
//    @OperationLog(module = OperationModel.SYS_CHANNEL,description =  OperationAction.ADD_OR_EDIT)
//    @PostMapping
...
//     * 刷新渠道层级和顺序
//     */
//    @OperationLog(module = OperationModel.SYS_CHANNEL,description = OperationAction.RELOAD)
//    @PostMapping("/reload")
