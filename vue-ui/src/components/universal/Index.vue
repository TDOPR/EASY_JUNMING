      ...
      <el-main>
        <div style="height: 200px">
          <el-form label-width="80px">
            ...
            <el-row
              v-for="columnList in searchMetaColumnList"
              :key="columnList"
            >
              <el-col :span="8" v-for="column in columnList" :key="column.code">
                <el-form-item
                  :label="column.name + ':'"
                  :key="column.code"
                  class="names"
...
export default {
  ...
  methods: {
    exportData() {
      this.$ajax.download("/api/universal/export", this.condition, this.metaName+".xlsx");
    },
    search() {
      let arr = [];
      ...
      this.$ajax
        ...
        .then((res) => {
          ...
          if (res.code == 200) {
            ...
            this.metaName=res.data.metaName;
