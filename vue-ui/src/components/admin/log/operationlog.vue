            ...
            <el-row>
              ...
              <el-col :span="4">
                <el-form-item label="模块" class="names">
                  <el-input v-model="condition.searchParam.module"></el-input>
                </el-form-item>
              </el-col>
            ...
            >
              ...
              <el-table-column label="详细信息">
                <template slot-scope="scope">
                  <span class="textover" :title="scope.row.content">{{
                    scope.row.content
                  }}</span>
                </template>
              </el-table-column>
...
export default {
  ...
  methods: {
    exportData() {
      this.$ajax.download(
        "/api/admin/operationlog/export",
        this.condition,
        '操作日志_'+this.$utils.getDetailTimeIgnoreUnit()+".xlsx"
      );
    },
    ...
    if (this.createDate != null) {
      ...
      this.$ajax
        .post("/api/admin/operationlog/pagelist", this.condition)
        .then((res) => {
          if (res.code == 200) {
